...
- [2026-07-17—2026-07-21 单摄项目收敛与板卡/协作依赖执行方案](board_dependent_execution_plan_20260717.md)：**历史计划**；其中 UART0/G1 多 checkpoint 路线已被 I0 UART1 冻结方案替代。当前分工和执行入口见根目录 `CURRENT_STATE.md` 与 `docs/agent_context/TEAM_INTERFACE_FREEZE_AND_FINAL_DAY_OWNERSHIP_20260719.md`。
