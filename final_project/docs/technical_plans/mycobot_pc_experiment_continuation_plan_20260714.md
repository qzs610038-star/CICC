...
| E3 机械前置 | 基座刚性固定、安装版本标记、外部 180°基准、净空、急停/断电人、物块与台面 | 照片/视频、量角/量距方法和现场双人复核齐全 | BLOCKED，待用户现场确认 |
| E4 重新示教 | 使用 `--teach-only` 创建全新唯一命名 JSON | 明确 `--port` 和 `--confirm-action-gate`；不加载旧预设；不自动回零/抓放 | NO-GO |
