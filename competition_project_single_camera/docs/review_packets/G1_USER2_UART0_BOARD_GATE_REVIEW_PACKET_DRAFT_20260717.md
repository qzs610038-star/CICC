# HISTORICAL / SUPERSEDED — UART0 board-gate draft

> This draft does not authorize any current action. Current CPU Hello governance is the UART1 H0-H6 receipt packet: `CPU_HELLO_UART1_H0_H6_RECEIPT_20260721.md`.
