...
begin
	...
	begin
		...
		begin
			...
			end else if (r_y_cnt == 11'd1) begin
				if (i_valid)
				begin
		...
		begin
			...
			begin
				...
				r_b_00_00_1P[PW-1:P_DEPTH]	<= (((r_bayer_01_01_0P_0 >> 1) + (r_bayer_11_00_1P_0 >> 1)) >> 1) + (((r_bayer_11_01_0P_0 >> 1) + (r_bayer_01_00_1P_0 >> 1)) >> 1);
