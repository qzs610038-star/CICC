...
output	reg	[1:0]	wr_bank = 2'd0,
output	reg	[1:0]	rd_bank = 2'd0,
output	reg			rd_sw_ack = 1'd0,
output	reg			wr_sw_ack = 1'd0,
output	reg[ADDR_WIDTH-1:0] rd_start_addr = {ADDR_WIDTH{1'b0}},
output	reg[ADDR_WIDTH-1:0]	wr_start_addr = {ADDR_WIDTH{1'b0}}
