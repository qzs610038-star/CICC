...
module edb_top (
    ...
    output bscan_TDO,
    input  vio0_clk,
    output [7:0] vio0_contrast,
    output [7:0] vio0_lumi_r,
    output [7:0] vio0_lumi_g,
    output [7:0] vio0_lumi_b
);
    ...
    edb_vio_top #(
        .NUM_PROBE_IN           ( 0 ),
        .NUM_PROBE_OUT          ( 4 ),
        .UUID           ( 128'h9bda5d14ea334b109210c15735f0d970 ),
        .PROBE_OUT0_WIDTH       ( 8 ),
        .PROBE_OUT1_WIDTH       ( 8 ),
        .PROBE_OUT2_WIDTH       ( 8 ),
        .PROBE_OUT3_WIDTH       ( 8 ),
        ...
        .probe_in62         ( 1'b0 ),
        .probe_in63         ( 1'b0 ),
        .probe_out0         ( vio0_contrast ),
        .probe_out1         ( vio0_lumi_r ),
        .probe_out2         ( vio0_lumi_g ),
        .probe_out3         ( vio0_lumi_b ),
        .probe_out4         (  ),
        .probe_out5         (  ),
        .probe_out6         (  ),
        .probe_out7         (  ),
