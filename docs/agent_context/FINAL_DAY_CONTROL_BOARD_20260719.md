# HISTORICAL / SUPERSEDED — 2026-07-19 control board

> This dated control board does not govern the CPU_HELLO candidate. Current authority is `CURRENT_STATE.md` and `competition_project_single_camera/docs/review_packets/CPU_HELLO_UART1_H0_H6_RECEIPT_20260721.md`.
